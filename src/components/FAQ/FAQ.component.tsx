                ...
                <div className="bg-standard-7 p-8 desktop:p-[60px] rounded-[20px]">
                    ...
                    <div className="grid grid-cols-1 tablet:grid-cols-2 mt-10 gap-10">
                        <div className="flex flex-col gap-4">
                            <Accordion
                                labelText="What&rsquo;s the efficiency improvement I can expect using Urbx?"
                                defaultOpen
                            >
                                <p>
                            ...
                            <Accordion labelText="Can URBX&rsquo;s system be integrated with existing warehouses or material handling equipment?">
                                <p>
                            ...
                            <Accordion labelText="Can URBX&rsquo;s solutions handle a variety of goods and packing types?">
                                <p>
                            ...
                            <Accordion labelText="What is the typical lead time for deploying URBX&rsquo;s robotic system in a warehouse?">
                                <p>
                        ...
                        <div className="relative rounded-[20px] h-[356px] overflow-hidden">
                            ...
                            <div className="z-10 relative p-10">
                                <h4 className="font-bold text-2xl text-white">Don&rsquo;t have an answer?</h4>
                                <ButtonLink
                                    href="/contact-us"
