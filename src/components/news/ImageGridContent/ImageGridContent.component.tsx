...
// Define a type for media (either videoSrc or image)
type MediaContent = { videoSrc: string; image?: never } | { image: string; videoSrc?: never };

type ImageGridContentProps = MediaContent & {
    label: string;
